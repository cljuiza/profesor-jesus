                ...
                <Layaut className="m-15">
                    <div className="flex items-center justify-around w-full xl:flex-col">
                        ...
                        <div className="w-1/2 xl:w-auto flex flex-col items-center self-center">
                            ...
                            <br />
                            <p className="my-3 text-xl pr-3 sm:text-md sm:!text-center">Seré tu profesora de español e ingles, conmigo hablarás estos dos idiomas de manera eficaz, fluída y con seguridad.</p>
                            ...
                            <div className="w-9/12 flex justify-around items-center  md:flex-row xs:flex-col gap-4 mt-6 lg:self-center ">
                                ...
                                <motion.button whileHover={{ y: -3 }} whileTap={{ scale: 0.9 }} className="flex items-center justify-start gap-4 py-2 px-8 rounded-xl text-xl !text-left md:!text-center md:px-1 text-primary hover:text-textNav">
